...
package voiceinteraction.test.android.com.samplevoiceinteraction;
...
public class TestInteractionActivity extends Activity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (v == mAirplaneButton) {
            ...
            options[0] = new VoiceInteractor.PickOptionRequest.Option("One", 1);
            options[1] = new VoiceInteractor.PickOptionRequest.Option("Two", 2);
            options[2] = new VoiceInteractor.PickOptionRequest.Option("Three", 3);
            options[3] = new VoiceInteractor.PickOptionRequest.Option("Four", 4);
            options[4] = new VoiceInteractor.PickOptionRequest.Option("Five", 5);
